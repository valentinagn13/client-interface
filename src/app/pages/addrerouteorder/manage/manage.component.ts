...
export class ManageComponent implements OnInit {
  ...
  createForRoute() {
    ...
    this.AddreRouteOrder.route_id = this.route_id;
    console.log(JSON.stringify(this.AddreRouteOrder));
    this.AddreRouteOrderService.createForRoute(this.route_id, this.AddreRouteOrder).subscribe((data) => {
  ...
  createForAddress() {
    this.AddreRouteOrder.address_id = this.address_id;
    console.log(JSON.stringify(this.AddreRouteOrder));
    this.AddreRouteOrderService.createForAddress(this.address_id, this.AddreRouteOrder).subscribe((data) => {
      Swal.fire("Creado", "Se ha creado exitosamente", "success");
      // Redirigir a la lista de operaciones de la dirección específica
      this.router.navigate(["addreRouteOrders/filterByAddress", this.address_id]);
    });
  }
