...
export class SecurityService {
  ...
  */
  saveSession(dataSesion: any) {
    let data: User = { //aqui guarda la informacion del usuario logeado
  ...
  */
  setUser(user: User) { //nesecita que le llegue un usuario 
  ...
  * @returns
  */
  getUser() { //usuario y se lo tiene como un observavol por si el cambia todos loc componentes miren ese cambio
...
*/
  public get activeUserSession(): User { //nos devuelve o captura el usuario, obtenemos los datos del usuario
